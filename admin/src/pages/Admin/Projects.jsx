...
const AdminProjects = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingProject) await adminProjectsAPI.update(editingProject._id, formDataToSend)
      else await adminProjectsAPI.create(formDataToSend)
            ...
            <Card sx={{ borderRadius: '16px' }}>
              <CardContent>
                ...
                <Box sx={{ display: 'flex', gap: 1, alignItems: 'center', flexWrap: 'wrap' }}>
                  {project.githubUrl && (
                    <Button size="small" startIcon={<Code />} href={project.githubUrl} target="_blank">
                      Code
                    </Button>
                  )}
                  {project.liveUrl && (
                    <Button size="small" startIcon={<Launch />} href={project.liveUrl} target="_blank">
                      Live Demo
                    </Button>
                  )}
        ...
        <form onSubmit={handleSubmit}>
          <DialogContent>
            <Grid container spacing={2}>
              <Grid item xs={12}>
                <ImageUpload onImageChange={handleImageChange} currentImage={editingProject?.image} />
              </Grid>
              <Grid item xs={12}>
                <TextField
                  fullWidth
